...
class SuiEscrowService {
  constructor() {
    ...
    this.packageId = '0x8576a41bbaf9802d7c96afcbf0a0005ac7cbd084be526b48c6fe58c906b8dc38';
  }
  ...
  async createEscrow(senderKeypair, senderAddress, vendorAddress, verifierAddress, amount, unlockKey) {
    ...
    const [escrow, remainingCoin] = tx.moveCall({
      ...
      typeArguments: ['0x2::coin::Coin<0x8576a41bbaf9802d7c96afcbf0a0005ac7cbd084be526b48c6fe58c906b8dc38::demo_coins::USDC>'], // Placeholder; update with USDC type
      arguments: [
